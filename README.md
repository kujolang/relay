...
- `tests/relay_provider_tool_smoke.sh`: authenticated local Watchdog, provider-generated tool planning, Agents SDK execution, and evidence-backed repository mutation
