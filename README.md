...
- `tests/relay_contract_tests.kujo`: contract coverage for bounded JSON/JSONL evidence, provider payload/tool-ID limits, proxy-environment denial, and retryable versus non-retryable fallback classes
