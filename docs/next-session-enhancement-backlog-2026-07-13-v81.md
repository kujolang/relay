# Kujo Relay Next-Session Enhancement Backlog — v81

Relay remains a local-first hardened alpha/showcase, not a universally useful
enterprise-production platform. v81 serializes capability issuance and rejects
duplicate worker identities instead of replacing secrets. The next session
should prioritize external authority and cross-repository usefulness.
