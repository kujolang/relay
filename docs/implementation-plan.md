...
- Unified Relay symlink inspection behind a fail-closed helper: missing paths remain absent, dangling symlinks are detected through metadata before existence checks, and runtime probe errors are unsafe across evidence, workspace, dependency, control, and Agents SDK worker boundaries.
...
Current follow-on backlog: `docs/next-session-enhancement-backlog-2026-07-12-v43.md`.
