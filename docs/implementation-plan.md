...
- Fail-closed live Watchdog routing, explicit subprocess environments, configurable budgets, operator diagnostics/probes, and detached worktree creation with confirmed cleanup.
