# Kujo Relay next-session enhancement backlog — v44
...
closes state-store parent-path redirection and records the next evidence-backed
work.

## Completed in this review

- [x] Walk existing parent components for state and runs roots.
- [x] Reject symlinked parent directories and `..` before evidence/index access.
- [x] Preserve missing non-symlink components as creatable.
- [x] Add parent-redirection contract and state-store smoke coverage.
- [x] Update README, command reference, ADR-062, enterprise review, final
