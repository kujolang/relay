...
RELAY_ROOT="$PACKAGE" KUJO_BIN="$KUJO" KUJO_AI_SDK_PATH="$ROOT/../ai-sdk" "$PACKAGE/bin/relay" chat "Summarize the mission boundary" --fixture --json | jq -e '.ok == true' >/dev/null
